...
class HelperWidget {
  ...
  private addHelperIcon(): void {
    ...
    this.helperIcon.setAttribute("aria-label", "Epicure Assist");
    ...
    this.helperIcon.innerHTML = `<span class="er-icon" aria-hidden="true">ER</span><span class="sr-only">Epicure Assist</span>`;
    this.helperIcon.style.backgroundColor = backgroundColor;
    this.helperIcon.style.color = foregroundColor;
