...
const TipTapEditor = ({
  ...
  return (
    <div className={cn("relative flex flex-col gap-2", className)}>
      ...
      >
        <div
          className="flex-1 flex flex-col min-h-[160px] max-h-[400px] overflow-y-auto rounded-b p-3 text-sm text-foreground relative"
          onClick={focusEditor}
        ...
        >
          ...
          {attachments.length > 0 ? (
            <div className="flex w-full flex-wrap gap-3 pt-4 bg-muted/30 p-3 rounded-lg mt-4">
