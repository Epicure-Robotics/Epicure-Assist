...
type ConversationListContextType = {
  ...
  issueGroups: RouterOutputs["mailbox"]["issueGroups"]["listAll"]["groups"] | undefined;
};
    ...
    () => ({
      conversationListData: lastPage
        ? {
            ...
            supportsHighestValueSort: lastPage.supportsHighestValueSort,
      ...
      issueGroups: issueGroupsData?.groups,
    }),
    [
      currentConversationSlug,
      conversations,
...
export const useConversationListContext = () =>
  assertDefined(
    ...
    "useConversationListContext must be used within a ConversationListContextProvider",
  );
