...
import { bigint, boolean, index, integer, pgTable, text, timestamp, unique, vector } from "drizzle-orm/pg-core";
...
export const faqs = pgTable(
  ...
  (table) => [
    ...
    unique("faqs_source_conversation_id_key").on(table.sourceConversationId),
  ],
).enableRLS();
